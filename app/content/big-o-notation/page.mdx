...
Big-O notation is a way of describing the performance of an algorithm. **It is a way of describing how the runtime of an algorithm scales as the input grows.**
