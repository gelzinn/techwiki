...
export const Header = () => {
  ...
  return (
    <header
      className="mx-auto flex items-center justify-center overflow-hidden border-b border-zinc-200 bg-zinc-50 text-black dark:border-zinc-900 dark:bg-black dark:text-zinc-50"
      id="main-header"
    >
